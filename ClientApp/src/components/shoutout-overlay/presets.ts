...
export const LAYOUT_PRESETS: { id: PresetId; build: () => ShoutoutLayout }[] = [
    {
        ...
        build: () => build({ width: 1000, height: 300 }, [
            ...
            element('clip', 'clip', { x: 20, y: 20, width: 400, height: 260 }, { options: { radius: 14, noClip: 'offline' } }),
            element('live', 'live', { x: 34, y: 34, width: 104, height: 30 }),
            element('avatar', 'avatar', { x: 452, y: 36, width: 104, height: 104 }),
            element('badge', 'badge', { x: 528, y: 110, width: 30, height: 30 }),
    ...
    },
    {
        ...
        build: () => build({ width: 420, height: 580 }, [
            ...
            element('clip', 'clip', { x: 16, y: 16, width: 388, height: 218 }, { options: { radius: 14, noClip: 'offline' } }),
            element('live', 'live', { x: 30, y: 30, width: 104, height: 30 }),
            element('avatar', 'avatar', { x: 160, y: 190, width: 100, height: 100 }, { options: { borderWidth: 5, borderColor: '#ffffff' } }),
            element('badge', 'badge', { x: 236, y: 262, width: 30, height: 30 }),
    ...
    },
    {
        ...
        build: () => build({ width: 800, height: 450 }, [
            ...
            element('clip', 'clip', { x: 0, y: 0, width: 800, height: 450 }, { options: { radius: 18, shadow: true, noClip: 'offline' } }),
            element('live', 'live', { x: 24, y: 24, width: 110, height: 32 }),
            ...
            element('badge', 'badge', { x: 88, y: 398, width: 28, height: 28 }),
    ...
    },
    {
        ...
        build: () => build({ width: 900, height: 120 }, [
            ...
            element('badge', 'badge', { x: 82, y: 82, width: 26, height: 26 }),
            ...
            element('clip', 'clip', { x: 668, y: 10, width: 178, height: 100 }, { options: { radius: 12, noClip: 'offline' } }),
            element('live', 'live', { x: 676, y: 18, width: 70, height: 22 }, { options: { fontSize: 12, label: 'VIVO' } }),
            timer(730),
        ], { radius: 60 }),
    },
    {
        ...
        build: () => build({ width: 720, height: 170 }, [
            ...
            element('badge', 'badge', { x: 116, y: 116, width: 32, height: 32 }),
            element('live', 'live', { x: 36, y: 132, width: 98, height: 26 }, { options: { fontSize: 14 } }),
