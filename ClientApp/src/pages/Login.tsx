import { Bot, Shield, Clock, Palette, ShoppingBag, Loader2 } from 'lucide-react';
                    ...
                    <div className="space-y-4 mb-6">
                        ...
                        <div>
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-[#9146ff] to-[#772ce8] hover:from-[#772ce8] hover:to-[#5c16c5] text-white font-bold rounded-lg transition-all hover:-translate-y-0.5 shadow-lg disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                            >
                                ...
                                <span>{loggingIn ? t('redirecting') || 'Redirigiendo...' : exchanging ? t('authenticating') || 'Autenticando...' : t('continueWithTwitch')}</span>
                            </button>
                        ...
                        <div>
                            <button
                                ...
                                disabled={loggingIn || exchanging}
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-[#5865F2] to-[#4752C4] hover:from-[#4752C4] hover:to-[#3C45A5] text-white font-bold rounded-lg transition-all hover:-translate-y-0.5 shadow-lg disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                            >
                                {loggingIn || exchanging ? (
                                    <Loader2 className="w-6 h-6 animate-spin" />
                                ) : (
                                ...
                                <span>{loggingIn ? t('redirecting') || 'Redirigiendo...' : exchanging ? t('authenticating') || 'Autenticando...' : t('continueWithDiscord')}</span>
                            </button>
                            <p className="text-xs text-[#64748b] dark:text-[#94a3b8] mt-1.5 ml-1">
