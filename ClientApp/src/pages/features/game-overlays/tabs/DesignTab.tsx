            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                ...
                <Card>
                    ...
                    <div className="mt-4 space-y-4">
                        ...
                        {selected === 'prediction' && <p className="text-[11px] text-[#6b7280]">Pozo en vivo de la predicción del chat (!pred win|loss): cuánto hay a cada lado, cuántos apostaron y cuándo cierra; al terminar, el lado ganador y quiénes acertaron. Se activa en Funciones → Decatron Coach → Predicciones. Usa "Desktop: En partida" o "Fin de partida" para verlo.</p>}
