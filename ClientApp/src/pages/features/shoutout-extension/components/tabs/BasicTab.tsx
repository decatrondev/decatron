        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#1B1C1D] rounded-2xl border border-[#e2e8f0] dark:border-[#374151] p-6 shadow-lg">
                ...
                <p className="text-xs text-[#64748b] dark:text-[#94a3b8] mt-3">
                    ⏱️ Tiempo que durará visible el shoutout en pantalla
                </p>
            </div>
            ...
            <div className="bg-white dark:bg-[#1B1C1D] rounded-2xl border border-[#e2e8f0] dark:border-[#374151] p-6 shadow-lg">
                ...
                <p className="text-xs text-[#64748b] dark:text-[#94a3b8] mt-3">
                    🛡️ Tiempo de espera antes de poder hacer otro shoutout al mismo usuario (evita spam)
                </p>
            </div>
                    ...
                    {textLines.map((line, index) => (
                        ...
                        >
                            ...
                            <p className="text-xs text-[#64748b] dark:text-[#94a3b8] mt-2">
                                💡 Usa @username para el nombre y @game para el juego
                            </p>
                        </div>
                    ))}
                </div>
