        ...
        <div className={cardClass}>
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h3 className="text-lg font-bold text-[#1e293b] dark:text-[#f8fafc] flex items-center gap-2">
                        ...
                        Integración con Timer Extensible
                    </h3>
                    <p className="text-sm text-[#64748b] dark:text-[#94a3b8]">
                        Suma tiempo al timer cuando recibas donaciones
                    </p>
                </div>
            ...
            {settings.timerIntegrationEnabled && (() => {
                ...
                const formatPreview = (s: number) => {
                    if (s >= 86400) return `${(s / 86400).toFixed(1)} días`;
                ...
                return (
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className={labelClass}>
                                    Tiempo por cada 1 {settings.currency}
                                </label>
                                <input
                                    type="number"
                                    min="1"
                        ...
                        <div className="p-4 bg-[#f8fafc] dark:bg-[#262626] rounded-xl border border-[#e2e8f0] dark:border-[#374151]">
                            <p className="text-sm text-[#64748b] dark:text-[#94a3b8]">
                                <span className="font-bold text-[#1e293b] dark:text-[#f8fafc]">Ejemplo: </span>
                                Una donación de {formatCurrency(exampleAmount)} sumará{' '}
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-bold text-green-700 dark:text-green-300">
                                        Donación = Más tiempo de stream
                                    </p>
                                    <p className="text-sm text-green-600 dark:text-green-400">
                                        El tiempo se sumará automáticamente al Timer Extensible
                                    </p>
                                </div>
                            </div>
                        </div>
