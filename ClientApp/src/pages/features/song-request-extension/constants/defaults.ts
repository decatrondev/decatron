import type {
    ElementConfig, ElementId, OverlayAnimations, OverlayLayout, OverlayTheme,
    SongRequestOverlayConfig, SongRequestSettings, TextStyle, QueueItem,
} from '../types';
...
export const TEXT_ELEMENTS: ElementId[] = ['title', 'artist', 'requester', 'time', 'next', 'queue', 'source'];
